...
<body class="blue-grey darken-4">
    ...
    <?php
        ...
        $tab_affiche = recherche($bdd,$_GET["titre"],$_GET["realisateur"],$_GET["categorie"],$_GET["annee"]);
    ?>

    <div class="nav-wrapper chemin">
      <div class="col s12">
        <a href="accueil.php" class="breadcrumb">Accueil</a>
        <a href="listefilm.php" class="breadcrumb">Films</a>
      </div>
    </div>

    <article class="section">
        <h1>Les films correspondant :</h1>
